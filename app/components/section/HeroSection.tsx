...
const HeroSection = () => {
  return (
    <section className="flex justify-between items-center mt-8 md:z-[9999]">
      <div className="pt-32 md:pt-4">
        ...
        <p className="my-[1.6rem] font-bold leading-[1.692rem] text-lightGray text-[1rem]">
          Built Wicket longer admire do barton vanity itself do in it. <br/> Preferred
          to sportsmen it engrossed listening. Park gate <br/> sell they west hard for
          the.
        </p>
        ...
        <div className="flex gap-6 items-center ">
          ...
          <div className="flex items-center mt-6 hover:cursor-pointer">
            <img src="/images/play-shadow.png" alt=" Rounded play " />
